...
function testWinner(a0, a1, b0, b1, c0, c1, d0, d1, e0, e1){
	...
	if(undImage == currPos[e0][e1].backgroundImage &&
...
var btnRotateRight = Ti.UI.createButton({
	backgroundImage: 'images/rightButton.png',
	right: '10dp',
	top: '475dp',
	width:'60dp',
	height:'40dp',
...
var btnRotateLeft = Ti.UI.createButton({
	backgroundImage: 'images/leftButton.png',
	left: '10dp',
	top: '475dp',
	width:'60dp',
	height:'40dp',
...
btnDone.addEventListener('click', function(e){
	...
	if(currentAction == 0){
		...
		if(rotationIsNew){
			soundMarblePlaced();
			currentAction = changeAction(currentAction);
			Ti.include('computerPlayer.js');
			//findAllPosibleMoves(currPos);
		}else{
			soundError();
